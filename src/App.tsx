...
import { AiProvidersList, AiProvidersCreate, AiProvidersEdit } from "./pages/ai-providers";
...
import { PromptsList, PromptsCreate, PromptsEdit, PromptsShow } from "./pages/prompts";
